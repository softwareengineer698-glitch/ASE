...
// Stored in Firestore: donations_history/{recordId}
// Written when a donation is completed or expires.

class DonationHistoryRecord {
  final String id;
  ...
  final String outcome; // 'completed' | 'expired' | 'partial'
  ...
  factory DonationHistoryRecord.fromMap(
    ...
    return DonationHistoryRecord(
      id: docId,
      donorId: map['donorId'] ?? '',
      category: map['category'] ?? '',
      itemType: map['itemType'] ?? 'food',
