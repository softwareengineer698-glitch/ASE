...
class DeliveryConfirmation {
  ...
  const DeliveryConfirmation({
    ...
    required this.quantityDelivered, required this.foodCategory, required this.createdAt, this.donorSignature,
    this.ngoSignature,
    this.notes,
    this.confirmedAt,
...
class DeliveryPhoto {
  ...
  const DeliveryPhoto({
    ...
    required this.type, required this.capturedAt, this.firebaseUrl,
    this.caption,
    this.latitude,
    this.longitude,
  });
